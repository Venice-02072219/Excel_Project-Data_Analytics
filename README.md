...
1.  Download the `[Your_Dashboard_File_Name].xlsx` file from this repository.
...
4.  Use the interactive **Slicers** on the left side of the dashboard to filter data by region, country, or specific year brackets.
...
*   [LinkedIn Profile Link]([Add your link here])
*   [Portfolio Website Link]([Add your link here])
